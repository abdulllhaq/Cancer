...
def user_report():
  ...
  Compactness = st.sidebar.slider('Compactness', 0,0.4, 0.1 )
  Concavity = st.sidebar.slider('Concavity', 0,0.5, 0.1 )
  Concave_points = st.sidebar.slider('Concave points', 0,0.25, 0.05 )
  Symmetry = st.sidebar.slider('Symmetry', 0,0.4, 0.2 )
  Fractal_Dimension = st.sidebar.slider('Fractal Dimension', 0,0.01, 0.06 )
...
plt.xticks(np.arange(0,100,5))
plt.yticks(np.arange(0,0.25,0.0125))
plt.title('0 - Healthy & 1 - Unhealthy')
